...
function TriajeScreen({ navigation }) {
	...
	const updateData = async () => {
		if(answerToQuestion1 == '' || answerToQuestion2 == '' || answerToQuestion3 == '' || answerToQuestion4 == '' || answerToQuestion5 == '' || answerToQuestion6 == '' || answerToQuestion7 == '' ||
			answerToQuestion8 == '' || answerToQuestion9 == '' || answerToQuestion10 == '' || answerToQuestion11 == '' ||  answerToQuestion12 == ''){
			...
			<ScrollView style={styles.scrollView}>
				...
				<View style={styles.itemContainer} >
					<View style={styles.item}>
						<View style={styles.titleItemContainer}>
							<Text style={styles.textItem}>
								¿Toma algúna medicación de manera regular?
							</Text>
						</View>
						<View style={styles.itemCheckbox}>
							<CheckBox
				...
				<View style={styles.itemContainer} >
					<View style={styles.item}>
						<View style={styles.titleItemContainer}>
							<Text style={styles.textItem}>
								¿Tiene algún tipo de Alergia conocida?
							</Text>
						</View>
						<View style={styles.itemCheckbox}>
							<CheckBox
				...
				<View style={styles.itemContainer} >
					<View style={styles.itemRadioContainer}>
						<View style={styles.titleItemContainer}>
							<Text style={styles.textItem}>
								¿Cauntas Horas duerme promedio cada noche?
							</Text>
						</View>
				...
				<View style={styles.itemContainer} >
					<View style={styles.item}>
						<View style={styles.titleItemContainer}>
							<Text style={styles.textItem}>
								¿Fuma o consume alcohol regularmente?
							</Text>
						</View>
						<View style={styles.itemCheckbox}>
							<CheckBox
				...
				<View style={styles.itemContainer} >
					<View style={styles.item}>
						<View style={styles.titleItemContainer}>
							<Text style={styles.textItem}>
								¿Ha recibido algna vacuna recientemente?
							</Text>
						</View>
						<View style={styles.itemCheckbox}>
							<CheckBox
