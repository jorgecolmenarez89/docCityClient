...
export const getEspecialistasByMunicipio = (municipioId, especialidadId) => {
  return axiosInstance.get(`/users/GetDoctorByMunicipioAndSpeciality/${municipioId}/${especialidadId}`);
}

export const getEspecialistasByParroquia = (parroquiaId, especialidadId) => {
  return axiosInstance.get(`/users/GetDoctorByParroquiaAndSpeciality/${parroquiaId}/${especialidadId}`);
}
